...
In het Klimaatakkoord is afgesproken dat Nederland in 2050 aardgasvrij moet zijn. Hier wordt stapsgewijs naar toe gewerkt. In 2050 moeten alle ruim 8 miljoen woningen en 1,2 miljoen andere gebouwen (Utiliteitsgebouwen) geïsoleerd zijn en op een duurzame manier worden verwarmd. Om dit te bereiken moet in 2030 circa 1,5 miljoen gebouwen van het aardgas af, dan wel verduurzaamd zijn. De ambitie is om dit te realiseren via een gebiedsgerichte aanpak waarin gemeenten de regie voeren. In 2021 hebben gemeenten een Transitievisie Warmte (Tvw) opgesteld. Hierin hebben zij het tijdspad inzichtelijk gemaakt wanneer in welke gebieden de levering van aardgas wordt stopgezet. Voor de gebieden die voor 2030 zijn aangewezen, heeft de gemeente de mogelijke warmtealternatieven in beeld gebracht. Met de komst van de Wet gemeentelijke instrumenten warmtetransitie (Wgiw), die naar verwachting op 1 juli 2026 ingaat, wordt de Tvw omgezet naar een verplicht warmteprogramma. Het warmteprogramma moet uiterlijk 31 december 202[RB2.1]7 vastgesteld zijn en beschrijft de aanpak tot 2035 voor het aardgasvrij maken van buurten, wijken, dorpen en steden. Het warmteprogramma wordt daarna elke vijf jaar (of vaker indien nodig) geactualiseerd. Veel gemeenten zijn inmiddels gestart met het opstellen van het warmteprogramma.

Bij de planning van welk gebied wanneer overstapt op een alternatief voor aardgas spelen allerlei bouwtechnische, energetische, ruimtelijke, sociaal-maatschappelijke en economische aspecten een rol. Het is van belang dat de afweging zorgvuldig wordt gemaakt, waarbij bewoners, gebouweigenaren en andere belanghebbenden worden meegenomen. DEGO helpt gemeenten, via verschillende kaartlagen om meer inzicht te geven in deze aspecten.

Enkele hulpmiddelen voor het warmteprogramma:

- NPLW heeft een [handreiking](https://www.nplw.nl/warmteprogramma/handreiking) en een *ondersteuningsprogramma* ontwikkeld voor gemeenten om de inhoud van een warmteprogramma vorm te geven. In deze handreiking staat stap voor stap beschreven hoe een warmteprogramma eruit kan zien.
- De [Startanalyse aardgasvrije buurten](https://startanalyse.pbl.nl/) van PBL biedt een vergelijking op basis van de *nationale kosten* voor de warmtealternatieven. De startanalyse biedt een basis met landelijke gevalideerde data die gemeenten kunnen verrijken met lokale gegevens om tot een goed lokaal beeld te komen.
- TNO heeft een [eindgebruikers dashboard](https://egk.rijksapplicaties.nl/) ontwikkeld dat informatie geeft over de *eindgebruikerskosten* van de warmtetransitie, gekoppeld aan de meest voorkomende warmtestrategieën.
